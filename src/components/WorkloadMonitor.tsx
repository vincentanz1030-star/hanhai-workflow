    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
            ...
            <CardContent>
              <div className="space-y-2 max-h-96 overflow-y-auto">
                {overloadedUsers.map((user, index) => (
                  <div key={user.userId || `overload-${index}`} className="flex items-center justify-between p-3 bg-destructive/10 rounded">
                    <div className="flex-1">
        ...
        <Card className="md:col-span-1">
          ...
          <CardContent>
            <div className="space-y-2 max-h-96 overflow-y-auto">
              {byPosition.map((position, index) => (
                <div key={position.position || `position-${index}`} className="space-y-1">
                  <div
                    ...
                    <div className="pl-8 pr-3 py-3 space-y-2 bg-muted/30 rounded">
                      {loadingTasks[position.position] ? (
                        ...
                        <div className="space-y-2">
                          {positionTasks[position.position].map((task, index) => (
                            <div key={task.id || `task-${position.position}-${index}`} className="p-3 bg-background rounded border space-y-2">
